    ...
    return (
      <div className="mt-9 ">
        ...
        <form className="flex flex-col" action="" method="post">
          ...
          <div className="flex flex-col mt-4">
            <label htmlFor="encargadoRevisar" className="text-lg">Obra</label>
          ...
          <div className="flex flex-col mt-4">
            <label htmlFor="encargadoAprobar" className="text-lg">Obra</label>
